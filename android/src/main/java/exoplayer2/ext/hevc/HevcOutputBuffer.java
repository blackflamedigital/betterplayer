 ...
 */
/* package */ final class HevcOutputBuffer extends SimpleDecoderOutputBuffer {
  ...
  public HevcOutputBuffer(Owner<SimpleDecoderOutputBuffer> owner) {
    super(owner);
  }

//  public SimpleDecoderOutputBuffer(HevcDecoder owner) {
//    this.owner = owner;
//  }
